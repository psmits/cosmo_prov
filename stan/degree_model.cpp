...
namespace degree_model_model_namespace {
...
class degree_model_model : public prob_grad {
private:
    int N;
    int D;
    int M;
    ...
    matrix_d move;
public:
    degree_model_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        static const char* function__ = "degree_model_model_namespace::degree_model_model(%1%)";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        // model body
        {
            ...
            stan::math::assign(mu, add(add(add(add(beta_inter,multiply(beta_mass,mass)),multiply(diet,beta_diet)),multiply(move,beta_move)),log(off)));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "degree_model_model_namespace::write_array(%1%)";
        (void) function__; // dummy call to supress warning
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "degree_model_model_namespace::write_csv(%1%)";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double beta_inter = in__.scalar_constrain();
...
typedef degree_model_model_namespace::degree_model_model stan_model;
