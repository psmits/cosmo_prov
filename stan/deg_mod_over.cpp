...
namespace deg_mod_over_model_namespace {
...
class deg_mod_over_model : public prob_grad {
private:
    int N;
    int D;
    int M;
    ...
    matrix_d move;
public:
    deg_mod_over_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        static const char* function__ = "deg_mod_over_model_namespace::deg_mod_over_model(%1%)";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "deg_mod_over_model_namespace::write_array(%1%)";
        (void) function__; // dummy call to supress warning
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "deg_mod_over_model_namespace::write_csv(%1%)";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double beta_inter = in__.scalar_constrain();
...
typedef deg_mod_over_model_namespace::deg_mod_over_model stan_model;
