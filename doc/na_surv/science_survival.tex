...
% Detail the various things I'm estimating and what hypotheses are being dealt with. 
% occupancy -- expected decrease in extinction risk with increase in size
%   this is expected based on virtually everything piece of work ever
% body size -- plausibles either nothing, or increase extinction risk with size.
%   former is based on Tomiya, later is based on ecology/Liow
%   what if something else?
% diet
%   omnivory is lowest extinction risk of all
% loco
%   ground dwelling is lowest extinction risk of all
%   arboreal is greatest extinction risk of all
%
% complex models are realistic because life is complex
% a bunch of things to improve model realisim 
%   origination cohort
%   phylogenetic effect
...
%     marine groups
%     mammals (find the alroy paper)
%   extinction risk has BOTH temporal and phylogenetic aspects
%     decomposing variance, they provide about equal variance
%
