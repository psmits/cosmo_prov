  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item Mammals
          \begin{itemize}
            \item North America: \\1003 genera, 2366 species
            \item Europe: \\658 genera, 1767 species
          \end{itemize}
...
\begin{frame}
  ...
  % ground dwelling taxa > arboreal. ? scansorial
  % either big > small or big < small or big = small
\end{frame}
